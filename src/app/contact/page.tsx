        ...
        <div className={s.layout}>
          <div className={s.formCol}>
            ...
            {sent ? (
              ...
              <form className={s.form} onSubmit={submit}>
                ...
                <p className={s.note}>⚠️ Connect Formspree: replace YOUR_FORM_ID in contact/page.tsx</p>
              </form>
            )}
          </div>
          ...
          <div className={s.infoCol}>
            ...
            <div className={s.infoBlock}>
              ...
              <a href="https://music.youtube.com/channel/UCw8RIQdp_79fxJoYzrkic0A" target="_blank" rel="noopener noreferrer" className={s.infoLink}>YouTube Music ↗</a>
            </div>
            <div className={s.infoBlock}>
